...
<body>
    ...
    <nav class="navbar navbar-expand d-flex flex-row-reverse" style="background-color: #ebffec; height: 70px">
        <div class="container-fluid">
            <img src="../Bahan/Logo (1) 1.png" alt="Logo" style="width: 130px; height: auto" />
            ...
            <div>
                <a href="#">
                    <img src="../Bahan/user.png" alt="Profile Picture"
        ...
        <div class="container">
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="../html/detail_pesanan.html">Detail Pesanan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../html/sedang_dipesan.html">Sedang Diproses</a>
                    </li>
                </ul>
            </div>
        </div>
